...
- Remove exception thrown when a dataset containing non-fill values has
  a coordinate variable that contains only fill values. Now no error is thrown
  and masking is skipped for the dataset.
